...
public static class CharacterCreationTranslations
{
    public static void ApplyTo(string lobbyJsonPath)
    {
        ...
        SetMulti(1980,
            ...
            "Sulla costa meridionale dell'isola di Vylbrand, all'ombra di antiche scogliere\nscolpite dall'incessante impeto del Mare di Rhotano, sorge la talassocrazia di Limsa Lominsa.\nLa sua economia prospera principalmente grazie alla navigazione marittima, vantando fiorenti cantieri navali,\npesca d'altura e forge metallurgiche. Per garantire la sicurezza delle rotte marittime, la città schiera\nuna formidabile flotta nota come Cavalieri del Barracuda. Ciononostante, bande di pirati continuano a infestare\nle acque circostanti, dedite a scorrerie e saccheggi.");
        ...
        SetMulti(1981,
            ...
            "Nelle propaggini orientali della massa continentale di Aldenard, culla di vaste e fitte selve\ne fiumi impetuosi, sorge la nazione silvana di Gridania. Il paesaggio urbano è un mosaico armonioso\ndi canali d'acqua labirintici e grandi strutture in legno, modellate con tale grazia da sembrare parte integrante\ndell'ambiente naturale. La dea più venerata dalla cittadinanza è Nophica, la Matrona, ma profonda devozione\nè riposta anche nella saggezza dei Veggenti, giovani oracoli che guidano la nazione secondo la volontà\ndegli spiriti elementali del bosco.");
        ...
        SetMulti(1982,
            ...
            "Il vivace crocevia commerciale di Ul'dah sorge nel cuore dell'arido paesaggio desertico\ndell'Aldenard meridionale. La cultura uldhiana è celebre per l'opulenza e la ricchezza della nazione,\nderivante in gran parte dalle abbondanti risorse minerarie e dall'industria tessile. Sebbene la sovranità\nappartenga alla Sultana, il vero potere è esercitato dal Sindacato, un consiglio formato da sei tra gli esponenti\npiù influenti ed elitari della città. Nald'thal è la divinità patrona della nazione, e due imponenti sale consacrate\nai suoi due aspetti sorgono a oriente e a occidente della città.");
